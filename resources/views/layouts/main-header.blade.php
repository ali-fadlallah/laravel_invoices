            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                            ...
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ Route('markNotification') }}">
                                        <span class="badge badge-pill badge-warning mr-auto my-auto float-left">قراءه
                                            الكل</span>
                                    </a>
                                </div>
                                <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك
                                    {{ auth()->user()->unreadNotifications->count() }} اشعارات لم تقرا</p>
                            </div>
                            ...
                            @if (auth()->user()->unreadNotifications->count() != 0)
                                @foreach (auth()->user()->unreadNotifications as $noti)
                                    <div class="main-notification-list Notification-scroll">
                                        <a
                                            class="d-flex p-3 border-bottom"href="{{ route('invoice_details_index', Crypt::encrypt($noti->data['id'])) }}">
                                            <div class="notifyimg bg-pink">
                                                <i class="la la-file-alt text-white"></i>
                                            </div>
                                            <div class="mr-3">
                                                <h5 class="notification-label mb-1">
                                                    {{ $noti->data['title'] . ' ' . $noti->data['user'] }}</h5>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/faces/avatar.png') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ URL::asset('assets/img/faces/avatar.png') }}" class=""></div>
