            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/avatar.png') }}"><span
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'part_paid_invoices')) }}">الفواتير المدفوعة
                                    جزئيا</a>
                            </li>
                        @endcan

                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'archiveInvoice')) }}">
                                    ارشيف الفواتير
                                </a>
                            </li>
                        @endcan
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ Route('invoiceReports') }}">تقارير الفواتير</a>
                            </li>
                        @endcan

                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ Route('CustomersReports') }}">تقارير العملاء</a>
                            </li>
                        @endcan
